...
SWIFT_CLASS("_TtC7NewsApp15AlertController")
...
SWIFT_CLASS("_TtC7NewsApp26DetailedNewsViewController")
@interface DetailedNewsViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified news;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC7NewsApp17NewsCellTableView")
@interface NewsCellTableView : UITableViewCell
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified date_published;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC7NewsApp18NewsListDataSource")
...
SWIFT_CLASS("_TtC7NewsApp22NewsListViewController")
...
@interface NewsListViewController (SWIFT_EXTENSION(NewsApp))
...
SWIFT_CLASS("_TtC7NewsApp17SpinnerController")
@interface SpinnerController : UIViewController
- (void)loadView;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
